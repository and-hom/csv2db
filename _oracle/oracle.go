...
func MakeDbTool(db *sql.DB) common.DbTool {
	tool := oraDbTool{common.CommonDbTool{
		Db:db,
...
type oraDbTool struct {
	common.CommonDbTool
}

func (this oraDbTool) Exists(tableName common.TableName) (bool, error) {
	query := `SELECT EXISTS (
				   SELECT 1
...
func (this oraDbTool) LoadSchema(tableName common.TableName) (common.Schema, error) {
...
func (this oraDbTool) InsertQuery(tableName common.TableName, insertSchema common.InsertSchema) (string, []string, error) {
	return this.InsertQueryMultiple(tableName, insertSchema, 1)
}

func (this oraDbTool) InsertQueryMultiple(tableName common.TableName, insertSchema common.InsertSchema, rows int) (string, []string, error) {
...
func (this oraDbTool) CreateInserter(tableName common.TableName, insertSchema common.InsertSchema) (common.Inserter, error) {
